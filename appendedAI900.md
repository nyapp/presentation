...
---
# Azure portal
ポータルのResource Overview Pageからコンポーネントを管理することができます。これはプロビジョニングが完了すると使用することできます。

検索を作成する際に、下記のオプションを使用することができます。
...
<!-- これらは、Azureの検索ソリューションやその他のクラウドサービスを操作・管理するための異なるアプローチやツールです。それぞれの機能について詳しく説明します。
