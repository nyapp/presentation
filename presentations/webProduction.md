...
---
## 開発されたファイル（ソースコード）はどこに配置される？
特に初回の配置には様々な準備が必要。→

---
## 家(ホームページ)を作ったら、住所（ドメイン）を取得して土地（サーバー）に引っ越そう！
...
![bg right 90%](https://sskshogo.com/wp-content/uploads/2023/03/image-1.png)
