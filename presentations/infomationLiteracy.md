...
| ツール名            | 用途                       | 特徴                                                                                       | 主な利用シーン             |
|---------------------|----------------------------|--------------------------------------------------------------------------------------------|-----------------------------|
| Slack               | ビジネスコミュニケーション | チャネルやグループチャット、ファイル共有、外部アプリ連携に優れている                        | 企業内コミュニケーション    |
| Microsoft Teams     | ビジネスコミュニケーション | Microsoft 365との統合が強力で、ビデオ会議やコラボレーションツールも充実                     | 大企業や教育機関           |
| Discord             | コミュニティ・ゲーマー向け  | 音声チャットや画面共有、コミュニティ運営機能が豊富                                         | ゲームやオンラインコミュニティ |
| LINE                | 個人間のメッセージ          | 日本で広く普及、スタンプやタイムライン機能も充実                                           | 個人・プライベート利用      |
| Facebook Messenger  | 個人・ソーシャルメディア   | Facebookと連携、写真や動画の送受信、通話機能に対応                                         | Facebookユーザー間          |

---
![bg center 70%](https://static.it-trend.jp/article/img/sns_sns_mail-1_1.png)
...
> フォローアップメールの例題を通して下記の点を並びます。
	...
	5.	次のアクションの提案方法
	6.	明瞭で簡潔な表現
	7.	メールの基本構成（件名、挨拶、本文、締め）
	8.	プロフェッショナルなコミュニケーションスキル
...
1. 特定の送信者からフォルダーにすべてのメールを移動するルールをすばやく作成するには、ルールを作成するメッセージリスト内のメッセージを右クリックし、[ルール] の上にマウス ポインターを合わせ、[ルールの作成] を選択します。
